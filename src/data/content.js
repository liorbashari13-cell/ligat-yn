...
export const TIMELINE = [
  { step: '01', title: 'הרשמה', text: 'רישום הקבוצות נפתח — 19 מקומות בלבד' },
  { step: '02', title: 'שלב הבתים', text: 'פורמט ליגת אלופות — משחקים מול כל הקבוצות בבית' },
  { step: '03', title: 'נוקאאוט', text: 'רבע גמר, חצי גמר וגמר תחת זרקורים' },
  { step: '04', title: 'הגמר הגדול', text: 'הזוכים עולים לשחק מול כוכבי ליגת העל' },
]
